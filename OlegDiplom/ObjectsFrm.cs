...
{
    public partial class ObjectsFrm : Form
    {
        private string login;
        private int ae;
        public ObjectsFrm(string login)
        {
            InitializeComponent();
            this.login = login;
            LoadGrid();
        ...
        private void LoadGrid()
        {
            try
            {
                ...
                con.Open();
                string query = "Select * from ObjectsView";
        ...
        private void workerBox_TextChanged(object sender, EventArgs e)
        {
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            try
            {
                SqlConnection con = new SqlConnection("workstation id=OlegTrushDiplom.mssql.somee.com;packet size=4096;user id=TrueO_SQLLogin_1;pwd=t2djqjx6on;data source=OlegTrushDiplom.mssql.somee.com;persist security info=False;initial catalog=OlegTrushDiplom");
                con.Open();
                SqlCommand command = new SqlCommand("DELETE FROM Objects WHERE Id =@pId", con);
        ...
        {
            AddObjectFrm addObjectFrm = new AddObjectFrm(login,ae);
            this.Hide();
            addObjectFrm.Show();
        }
        ...
        {
            ae = Convert.ToInt32(workersInfoPredDataGridView.CurrentRow.Cells["Id"].Value);
            AddObjectFrm addObjectFrm = new AddObjectFrm(login, ae);
            this.Hide();
            addObjectFrm.Show();
        }
