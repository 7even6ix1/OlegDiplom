...
{
    public partial class workersGroupsFrm : Form
    {
        private string login;
        private int ae;
        public workersGroupsFrm(string login)
        {
            InitializeComponent();
            this.login = login;
            LoadGrid();
        ...
        private void LoadGrid()
        {
            try
            {
                ...
                con.Open();
                string query = "Select * from WorkersInGroupsView ";
        ...
        {
            AddWorkerFrm addWorkerFrm = new AddWorkerFrm(login, ae);
            this.Hide();
            addWorkerFrm.Show();
        }
